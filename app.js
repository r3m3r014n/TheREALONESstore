const products = [
    { id: 1, name: "Jacket & Cap", category: "Casual Streetwear", price: 3300, image: "/grade-a-vintage-graphic-tee.jpg", badge: "Bestseller", desc: "Bundle deal: stylish jacket plus matching cap for an effortless streetwear fit." },
    { id: 2, name: "Cotton Sweaters", category: "Casual Streetwear", price: 1500, image: "/thrifted-cargo-pants-olive.jpg", badge: "Hot", desc: "Soft cotton sweaters priced for everyday wear. Cozy, breathable, and ready for layering." },
    { id: 3, name: "Air Force 1s, T-Shirt & Cap", category: "Neatfit Collection", price: 5300, image: "/gently-used-air-force-1s.jpg", badge: "Shoe Lover", desc: "Complete set featuring Air Force 1s, a clean tee, and a coordinating cap for a full look." },
    { id: 4, name: "T-Shirts", category: "Casual Streetwear", price: 1000, image: "/oversized-flannel-shirt.jpg", badge: "", desc: "Classic tees at a friendly price. Everyday essentials for easy styling." },
    { id: 5, name: "White Striped Shirts", category: "Casual Streetwear", price: 1000, image: "/retro-running-sneakers.jpg", badge: "Trending", desc: "White striped shirts with a clean, minimalist vibe. Perfect for smart-casual fits." },
    { id: 6, name: "Cap & Chanel Bag", category: "Casual Streetwear", price: 5800, image: "/classic-denim-jacket.jpg", badge: "", desc: "Cap plus Chanel-inspired bag bundle. Statement accessories for an elevated finish.", keywords: "Nairobi Thrift, Streetwear Kenya, Chanel bag bundle, statement accessories" },
    ...
    { id: 8, name: "Shoes", category: "Casual Streetwear", price: 3500, image: "/thrifted-streetwear-hoodie.jpg", badge: "", desc: "Versatile shoes prepped and ready to wear. Clean, dependable, and easy to style.", keywords: "Nairobi Thrift, Streetwear Kenya, everyday shoes" },
    { id: 9, name: "Pink New Balance", category: "Neatfit Collection", price: 3500, image: "/premium-neatfit-jordans.jpg", badge: "Exclusive", desc: "Pink New Balance sneakers with a sleek retro-runner aesthetic. Quality Vintage sneaker heat with fast delivery in Nairobi.", keywords: "Nairobi Thrift, Streetwear Kenya, Quality Vintage, pink new balance sneakers, retro runner style" },
    { id: 10, name: "White New Balance", category: "Neatfit Collection", price: 3500, image: "/y2k-baggy-jeans.jpg", badge: "Trending", desc: "White New Balance sneakers for a clean, versatile look. Fresh thrift find for any fit.", keywords: "Nairobi Thrift, Streetwear Kenya, white new balance sneakers" },
    { id: 11, name: "Bag, Cap & Shoes", category: "Casual Streetwear", price: 9300, image: "/vintage-windbreaker.jpg", badge: "", desc: "Bundle with bag, cap, and shoes for a complete head-to-toe upgrade." },
    { id: 12, name: "New Balance 9060", category: "Neatfit Collection", price: 3500, image: "/chelsea-boots.jpg", badge: "Quality", desc: "New Balance 9060 sneakers with a chunky futuristic aesthetic. A Quality Vintage sneaker pick with fast delivery in Nairobi.", keywords: "Nairobi Thrift, Streetwear Kenya, Quality Vintage, new balance 9060, chunky sneaker" },
    { id: 13, name: "Nike Air & Cap", category: "Casual Streetwear", price: 4300, image: "/casual-summer-shorts.jpg", badge: "", desc: "Bundle: Nike Air sneakers paired with a cap for an instant streetwear finish.", keywords: "Nairobi Thrift, Streetwear Kenya, Nike Air bundle, cap" },
    { id: 14, name: "Nike", category: "Neatfit Collection", price: 3500, image: "/slip-on-casual-vans.jpg", badge: "", desc: "Nike sneakers in Grade A condition. Cleaned, prepped, and ready to wear." }
];
